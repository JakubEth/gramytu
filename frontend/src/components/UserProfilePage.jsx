...
export default function UserProfilePage({ user, onUpdate }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-indigo-100 flex justify-center py-12 px-2">
      <div className="flex justify-center items-center w-full gap-4">
        {/* LEWY BANER */}
        <div className="hidden lg:flex flex-col w-40 self-center">
          <div className="bg-indigo-100 border-2 border-indigo-200 rounded-2xl shadow-lg flex flex-col items-center justify-center h-[600px] w-36 my-8">
            <a href="https://startup2025.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-4 hover:scale-105 transition">
              <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=200&q=80" alt="Reklama" className="rounded-xl w-24 h-24 object-cover shadow" />
              <span className="font-bold text-indigo-700 text-center text-sm mt-2">Dołącz do <br />Startup 2025!</span>
              <span className="text-xs text-indigo-500 mt-1">Zmień swój świat</span>
            </a>
          </div>
        </div>

        {/* GŁÓWNA TREŚĆ PROFILU */}
        <div className="bg-white/90 rounded-3xl shadow-2xl p-10 w-full max-w-5xl flex flex-col gap-10 animate-fade-in z-10">
        ...
        {/* PRAWY BANER */}
        <div className="hidden lg:flex flex-col w-40 self-center">
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-2xl shadow-lg flex flex-col items-center justify-center h-[600px] w-36 my-8">
            <a href="https://gramytu.pl/premium" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 p-4 hover:scale-105 transition">
              <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=200&q=80" alt="Premium" className="rounded-xl w-24 h-24 object-cover shadow" />
              <span className="font-bold text-yellow-700 text-center text-sm mt-2">GramyTu Premium</span>
              <span className="text-xs text-yellow-600 mt-1">Bez reklam, więcej możliwości!</span>
            </a>
          </div>
        </div>
      </div>
